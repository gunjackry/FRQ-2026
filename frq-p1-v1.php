...
function frq_p1_v1_render_shortcode($atts = []): string
{
    ...
    <div id="frq-p1-v1-app" class="frq-p1-v1">
        ...
        <div class="frq-p1-v1__controls">
            <button type="button" id="frq-add-root">Add Person to Generation 1</button>
        </div>

        <div id="frq-generation-notice" class="frq-p1-v1__notice" aria-live="polite"></div>
        <div id="frq-person-list" class="frq-p1-v1__person-list"></div>
        ...
        <div class="frq-p1-v1__section">
            ...
            <p class="frq-help">Name and email are required only when submitting Phase 1 (not for draft saves).</p>
        </div>
        ...
        <div class="frq-p1-v1__actions">
            <button type="button" id="frq-save-draft">Save Draft</button>
        ...
        <div class="frq-p1-v1__section">
            ...
            <button type="button" id="frq-share">Share Read-Only Copy</button>
